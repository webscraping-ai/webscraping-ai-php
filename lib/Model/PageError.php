 ...
 * @link     https://openapi-generator.tech
 */
class PageError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageError';
     ...
     * Sets status_code
     *
     * @param int|null $status_code Response HTTP status code (403, 500, etc)
     *
     * @return $this
     */
