...
Analyze web pages using LLMs

All URIs are relative to https://api.webscraping.ai, except if the operation defines another base path.

| Method | HTTP request | Description |
| ------------- | ------------- | ------------- |
| [**getFields()**](AIApi.md#getFields) | **GET** /ai/fields | Extract structured data fields from a web page |
...
```php
getFields($url, $fields, $headers, $timeout, $js, $js_timeout, $wait_for, $proxy, $country, $custom_proxy, $device, $error_on_404, $error_on_redirect, $js_script): array<string,string>
```
...
| **fields** | [**array<string,string>**](../Model/string.md)| Object describing fields to extract from the page and their descriptions | |
...
```php
getQuestion($url, $question, $headers, $timeout, $js, $js_timeout, $wait_for, $proxy, $country, $custom_proxy, $device, $error_on_404, $error_on_redirect, $js_script, $format): string
```
...
try {
    $result = $apiInstance->getQuestion($url, $question, $headers, $timeout, $js, $js_timeout, $wait_for, $proxy, $country, $custom_proxy, $device, $error_on_404, $error_on_redirect, $js_script, $format);
    print_r($result);
} catch (Exception $e) {
